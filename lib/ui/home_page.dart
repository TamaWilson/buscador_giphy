...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if(_searchControler.text == null || _searchControler.text.isEmpty) {
        response = await http.get("https://api.giphy.com/v1/gifs/trending?api_key=cyU3lUeLG0Ck4uL8t0gnmal6NuPVXBsj&limit=20&rating=R");
    } else {
        response = await http.get("https://api.giphy.com/v1/gifs/search?api_key=cyU3lUeLG0Ck4uL8t0gnmal6NuPVXBsj&q=${_searchControler.text}&limit=19&offset=$_offSet&rating=R&lang=en");
  ...
  Widget _createGifTable(BuildContext context, AsyncSnapshot snapshot) {
      return GridView.builder(
          ...
          itemBuilder: (context, index) {
            if(_searchControler.text == null || index < snapshot.data["data"].length){
